...
const DependantArray = ({ nestIndex, control, watch }) => {
	const { fields, remove, append } = useFieldArray({
		control,
		name: `insured_person.${nestIndex}.dependants`,
	});
					...
					<div key={i} className="tw-w-full tw-h-full">
						<div
							...
							<div className="tw-w-full tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-5">
								<Controller
									name={`insured_person[${nestIndex}].dependants[${i}].first_name`}
									control={control}
									defaultValue={''}
									rules={{
								...
								/>
								<Controller
									name={`insured_person[${nestIndex}].dependants[${i}].last_name`}
									control={control}
									defaultValue={''}
									rules={{
							...
							<div className="tw-w-full tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-5">
								<Controller
									name={`insured_person[${nestIndex}].dependants[${i}].email`}
									control={control}
									defaultValue={''}
									rules={{
										pattern: {
								...
								/>
								<Controller
									name={`insured_person[${nestIndex}].dependants[${i}].telephone`}
									control={control}
									rules={{
										pattern: {
											value:
							...
							<div className="tw-w-full tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-5">
								<Controller
									name={`insured_person[${nestIndex}].dependants[${i}].dob`}
									control={control}
									defaultValue={''}
									rules={{
								...
								<Controller
									name={`insured_person[${nestIndex}].dependants[${i}].gender`}
									control={control}
									defaultValue={''}
									rules={{
							...
							<div className="tw-w-full tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-5">
								<Controller
									name={`insured_person[${nestIndex}].dependants[${i}].passport_number`}
									control={control}
									defaultValue={''}
									rules={{
								...
								<Controller
									name={`insured_person[${nestIndex}].dependants[${i}].relationship_type`}
									control={control}
									defaultValue={''}
									rules={{
